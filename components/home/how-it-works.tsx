...
const steps: Step[] = [
  {
    ...
    label: "Upload PDF",
    description:
      "Drag and drop your PDF file or upload it directly from your device.",
  },
  {
    icon: <BrainCircuit size={64} strokeWidth={1.5} />,
    label: "AI Analysis",
    description:
      "Our AI analyzes the content to extract key information and insights.",
  },
  {
      ...
      <div className="flex flex-col gap-4 h-full">
        <div
          className="flex items-center justify-center h-24 w-24 mx-auto rounded-2xl
                bg-linear-to-br from-rose-500/10 to-transparent group-hover:from-rose-500/20 transition-colors"
        >
