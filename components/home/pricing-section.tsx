...
const PricingCard = ({
  ...
  return (
    <MotionDiv
      ...
      className="relative w-full max-w-lg hover:scale-105 hover:transition-all 
                           hover:shadow-2xl hover:shadow-rose-200 duration-300 rounded-2xl"
    >
      <div
        className={cn(
          `relative flex flex-col h-full gap-4 lg:gap-8 z-10 p-8 
            border-[1px] border-gray-500/20 rounded-2xl`,
    ...
    className="relative overflow-hidden" id="pricing">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        <MotionDiv variants={itemVariants} className="flex items-center justify-center w-full pb-12">
          <h2 className="uppercase font-bold text-xl lg:text-2xl mb-8 text-rose-500">
            Pricing
          </h2>
        </MotionDiv>
        <div
