    ...
    <div className="flex gap-4 mb-4 justify-between">
      <div className="space-y-6">
        <div className="flex flex-wrap items-center gap-4">
          <div className="rounded-full bg-linear-to-r hover:from-rose-300 hover:via-rose-500 hover:to-rose-800 ">
            <Badge
              className="relative px-4 py-1.5 text-sm font-medium bg-white/80 backdrop-blur-xs rounded-full transition-all duration-200 
